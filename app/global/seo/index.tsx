...
const SeoHead = (props: any) => {
  ...
  return (
    <Head>
      ...
      <meta
        name="keywords"
        content="mobile number lookup, scammer lookup, phone number lookup, phone number rating, phone number comments, scam identification, phone number details, protect from scams"
      />
      <meta name="author" content="TheNumber.in" />
      <title>TheNumber.in - Mobile Number Lookup and Scam Identification</title>
      <meta
        property="og:title"
        key="og:title"
        content="TheNumber.in - Mobile Number Lookup and Scam Identification"
      />
      <meta
